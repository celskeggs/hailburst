#ifndef APP_THREAD_POSIX_H
#define APP_THREAD_POSIX_H
...
// name goes unused on POSIX; only used on FreeRTOS
#define thread_create(x, name, entrypoint, param) THREAD_CHECK(pthread_create((x), NULL, (entrypoint), (param)))
